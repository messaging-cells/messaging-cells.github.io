...
Objects are never really expected to be freed (umm\+\_\+free call) under normal use of the library. They just get acquired (see for example \hyperlink{classcell_ad710b11caf02e0a3d2e281cb0d46a44b}{cell\+::acquire}) and when finisehd using them they get inited and put in a pre-\/class double linked list by the \hyperlink{classagent_a10d8b14221d243aa3906c2d65d3fe7e8}{agent\+::release} method.

The per-\/class acquire and \hyperlink{classagent_a10d8b14221d243aa3906c2d65d3fe7e8}{agent\+::release} are small footprint methods runned from in-\/core memory (as opposed to the umm\+\_\+malloc functions) that can be used in the user\textquotesingle{}s high performance code.
