...
\hyperlink{send__msg_8cpp_a62a0d4f39a307b53420dd89522b62a70}{recv\_cell\_handler}(\hyperlink{classmissive}{missive}* msg)\{
    ...
    EMU\_CODE(
        EMU\_CK(\hyperlink{shared__eph_8h_a39a45617dcf4c16d9968aa9294e8a9e7}{mc\_addr\_is\_local}(msg->dst));
        mc\_core\_id\_t koid = \hyperlink{classkernel_ac3532ca84ebcf0d7f6aba1b8966acc72}{kernel::get\_core\_id}();
        MC\_MARK\_USED(koid);
        mc\_core\_nn\_t konn = \hyperlink{classkernel_a9bea88d9fe21bf2fb40d7c8a7656c30a}{kernel::get\_core\_nn}();
        MC\_MARK\_USED(konn);
...
\textcolor{keywordtype}{void} mc\_cores\_main() \{
    ...
    \textcolor{keywordflow}{if}(\hyperlink{global_8h_a76824b23f4a177c4535d83c3b89e2f54}{mck\_is\_ro\_co\_core}(0,0))\{
       ...
       already 0.}
        \hyperlink{classkernel_a525c68a30877cf40fc63bca8485f4eb8}{kernel::get\_core\_cell}()->\hyperlink{classcell_a234bbd022db21480b428b2f63662fe95}{handler\_idx} = 0;   \textcolor{comment}{// This is
    ...
    \textcolor{keywordflow}{if}(\hyperlink{global_8h_a76824b23f4a177c4535d83c3b89e2f54}{mck\_is\_ro\_co\_core}(0,1))\{
        ...
        \hyperlink{classcell}{cell}* act1 = \hyperlink{classkernel_a525c68a30877cf40fc63bca8485f4eb8}{kernel::get\_core\_cell}();
        \hyperlink{classcell}{cell}* act2 = \hyperlink{classkernel_a525c68a30877cf40fc63bca8485f4eb8}{kernel::get\_core\_cell}(dst);
