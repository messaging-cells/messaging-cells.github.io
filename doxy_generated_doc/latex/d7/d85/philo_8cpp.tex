...
\begin{DoxyCompactList}\small\item\em Class for chopsticks (\hyperlink{philo_8cpp}{philo.\+cpp} example). \end{DoxyCompactList}\item 
class \hyperlink{classphilosopher}{philosopher}
\begin{DoxyCompactList}\small\item\em Class for philosophers (\hyperlink{philo_8cpp}{philo.\+cpp} example ). \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{philo_8cpp_a80458da12ef75d2c9eb5f185b2e09d73}{glb\+\_\+stick}~(\&(glb\+\_\+philo\+\_\+workeru-\/$>$stick))\hypertarget{philo_8cpp_a80458da12ef75d2c9eb5f185b2e09d73}{}\label{philo_8cpp_a80458da12ef75d2c9eb5f185b2e09d73}

\begin{DoxyCompactList}\small\item\em Returns the local \hyperlink{classchopstick}{chopstick}. \end{DoxyCompactList}\item 
\#define \hyperlink{philo_8cpp_adcc662701c5f055b26a048484d17e2c6}{glb\+\_\+philo}~(\&(glb\+\_\+philo\+\_\+workeru-\/$>$philo))\hypertarget{philo_8cpp_adcc662701c5f055b26a048484d17e2c6}{}\label{philo_8cpp_adcc662701c5f055b26a048484d17e2c6}
...
\begin{DoxyCompactList}\small\item\em Returns the \hyperlink{classchopstick}{chopstick} in workeru with \textquotesingle{}id\textquotesingle{}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Returns the \hyperlink{classphilosopher}{philosopher} in workeru with \textquotesingle{}id\textquotesingle{}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\textcolor{preprocessor}{#ifdef MC\_IS\_PTD\_CODE}
...
\textcolor{keyword}{class }\hyperlink{classphilosopher}{philosopher};

\textcolor{preprocessor}{#define MAX\_BITES 10}

\textcolor{preprocessor}{#define PH\_DBG PTD\_PRT}
...
\textcolor{comment}{//ifdef PHILO\_WITH\_DBG}
    ...
    tok\_to\_str(philo\_tok\_t tok)\{
        ...
        \textcolor{keywordflow}{case} tok\_invalid:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"invalid"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_eat:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"eat"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_take:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"take"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_taken:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"taken"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_not\_taken:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"not\_taken"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_drop:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"drop"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_droped:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"droped"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_not\_droped:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"not\_droped"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_yes\_full:
            \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"yes\_fll"});
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{default}:
            \hyperlink{global_8h_a6a6d1065bccc17077e1a6a0aeaa5f6dd}{mck\_abort}(1, mc\_cstr(\textcolor{stringliteral}{"BAD\_PHILO\_TOK"}));
        \textcolor{keywordflow}{break};
        \}
        \textcolor{keywordflow}{return} mc\_cstr(\textcolor{stringliteral}{"NO\_TOK"});
    \}
...
\textcolor{keyword}{public}:
    MCK\_DECLARE\_MEM\_METHODS(\hyperlink{classchopstick}{chopstick}, mc\_mod0\_cod)
    ...
    \textcolor{keyword}{virtual} 
    grip&   \hyperlink{classchopstick_ac7d6b96a8fa73a13464359b88eddc5c9}{get\_available}();
\};

\textcolor{keyword}{class }\hyperlink{classphilosopher}{philosopher} : \textcolor{keyword}{public} \hyperlink{classcell}{cell} \{
\textcolor{keyword}{public}:
    \hyperlink{cell_8hh_a16c403a50331aa5b5d01d33acc14ade4}{MCK\_DECLARE\_MEM\_METHODS}(\hyperlink{classphilosopher}{philosopher}, mc\_mod0\_cod)
    ...
    \hyperlink{shared__eph3_8h_ac84be73145b663d3392b6955cbc19c3b}{mc\_workeru\_id\_t}  lft\_stk\_id;
    \hyperlink{shared__eph3_8h_ac84be73145b663d3392b6955cbc19c3b}{mc\_workeru\_id\_t}  rgt\_stk\_id;
    \hyperlink{classchopstick}{chopstick}*     lft\_stick;
    \hyperlink{classchopstick}{chopstick}*     rgt\_stick;
    \hyperlink{shared__eph3_8h_ac84be73145b663d3392b6955cbc19c3b}{mc\_workeru\_id\_t}  lft\_phi\_id;
    \hyperlink{shared__eph3_8h_ac84be73145b663d3392b6955cbc19c3b}{mc\_workeru\_id\_t}  rgt\_phi\_id;
    \hyperlink{classphilosopher}{philosopher}* lft\_philo;
    \hyperlink{classphilosopher}{philosopher}* rgt\_philo;
    ...
    \hyperlink{classphilosopher}{philosopher}()\{
        init\_philosopher();
    \}
...
\textcolor{comment}{// For global data. DO NOT USE GLOBAL VARIABLES IF YOU WANT THE PTD (workerus as threads) TO WORK.}
\textcolor{keyword}{class }philo\_workeru \{
\textcolor{keyword}{public}:
    \hyperlink{cell_8hh_a16c403a50331aa5b5d01d33acc14ade4}{MCK\_DECLARE\_MEM\_METHODS}(philo\_workeru, mc\_mod0\_cod)

    philo\_workeru()\{        \textcolor{comment}{// NEED THIS SO THAT no memset func call}
        init\_philo\_workeru();
    \}       
    ~philo\_workeru()\{\}      \textcolor{comment}{// NEED THIS SO THAT no memset func call}

    \hyperlink{classchopstick}{chopstick} stick;
    \hyperlink{classphilosopher}{philosopher} philo;
    grip ava\_chopstick;
    grip ava\_philosopher;

    mc\_size\_t from\_manageru\_work\_sz;
    mc\_size\_t to\_manageru\_work\_sz;
    ...
    \textcolor{keywordtype}{void} init\_philo\_workeru()\{
        from\_manageru\_work\_sz = 0;
        to\_manageru\_work\_sz = 0;
        in\_work\_sz = 0;
        local\_work\_sz = 0;
        out\_work\_sz = 0;
        sent\_work\_sz = 0;
...
\hyperlink{cell_8hh_aad0dec1d661f1fdb5a2ccb767d712c75}{MCK\_DEFINE\_ACQUIRE\_ALLOC}(philo\_workeru, 32);    \textcolor{comment}{// defines
       philo\_workeru::acquire\_alloc}

\textcolor{preprocessor}{#define glb\_philo\_workeru ((philo\_workeru*)(mck\_get\_kernel()->user\_data))}

\textcolor{preprocessor}{#define glb\_stick (&(glb\_philo\_workeru->stick))}

\textcolor{preprocessor}{#define glb\_philo (&(glb\_philo\_workeru->philo))}

\textcolor{preprocessor}{#define glb\_ava\_sticks (glb\_philo\_workeru->ava\_chopstick)}
\textcolor{preprocessor}{#define glb\_ava\_philos (glb\_philo\_workeru->ava\_philosopher)}
...
\hyperlink{cell_8hh_aca3006fa8b9b5346c57139164f8e3591}{MCK\_DEFINE\_MEM\_METHODS}(\hyperlink{classchopstick}{chopstick}, 32, glb\_ava\_sticks, 0)
\hyperlink{cell_8hh_aca3006fa8b9b5346c57139164f8e3591}{MCK\_DEFINE\_MEM\_METHODS}(\hyperlink{classphilosopher}{philosopher}, 32, glb\_ava\_philos, 0)

grip&
\hyperlink{classchopstick}{chopstick}::\hyperlink{classchopstick_ac7d6b96a8fa73a13464359b88eddc5c9}{get\_available}()\{
    \textcolor{keywordflow}{return} glb\_ava\_sticks;
\}

grip&
\hyperlink{classphilosopher_a1efabe25b3e78f72610bacb408cf5518}{philosopher::get\_available}()\{
    \textcolor{keywordflow}{return} glb\_ava\_philos;
\}
...
philosopher\_handler(\hyperlink{classmissive}{missive}* msv)\{
    MCK\_CALL\_HANDLER(\hyperlink{classphilosopher}{philosopher}, handler, msv);
\}
...
chopstick::handler(\hyperlink{classmissive}{missive}* msv)\{
    ...
    \hyperlink{shared__eph3_8h_a804158edcb9b5bc2c1b2fb19d14e80d5}{mc\_workeru\_nn\_t} nn = \hyperlink{cell_8hh_af1eb47800585646e0caf6cb269111731}{mck\_get\_kernel}()->get\_workeru\_nn();
    PH\_DBG\_COD(
...
\textcolor{preprocessor}{        #ifdef PHILO\_EPH\_DBG}
            \hyperlink{shared__eph3_8h_ac84be73145b663d3392b6955cbc19c3b}{mc\_workeru\_id\_t} src\_id = \hyperlink{shared__eph3_8h_a7318efe779877691f45272404b4f14b8}{mc\_addr\_get\_id}(msv\_src);
            ...
            \hyperlink{log_8h_aa4f0190d914cecf5db43914dc69f7129}{mck\_xlog}((\hyperlink{shared__eph3_8h_ac03d1f3968bb5c52cf1de5cd9f250e66}{mc\_addr\_t})msv\_src);
            \hyperlink{log_8h_a8ec0c02a2d94dec909d9cdc8340f733f}{mck\_slog2}(\textcolor{stringliteral}{"\_\_\_"});
            ...
            \textcolor{keywordflow}{if}(nn == 15)\{
                ...
                \hyperlink{log_8h_aa4f0190d914cecf5db43914dc69f7129}{mck\_xlog}((\hyperlink{shared__eph3_8h_ac03d1f3968bb5c52cf1de5cd9f250e66}{mc\_addr\_t})(&(MC\_WORKERU\_INFO->inited\_workeru)));
                \hyperlink{log_8h_a8ec0c02a2d94dec909d9cdc8340f733f}{mck\_slog2}(\textcolor{stringliteral}{"\_\_\_\(\backslash\)n"});
...
\textcolor{preprocessor}{        #endif}
    ...
    \textcolor{keywordflow}{switch}(tok)\{
        ...
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{default}:
            \hyperlink{global_8h_a6a6d1065bccc17077e1a6a0aeaa5f6dd}{mck\_abort}(1, mc\_cstr(\textcolor{stringliteral}{"BAD\_STICK\_TOK"}));
        \textcolor{keywordflow}{break};
    \}
...
philosopher::handler(\hyperlink{classmissive}{missive}* msv)\{
    ...
    \textcolor{keywordflow}{switch}(tok)\{
        \textcolor{keywordflow}{case} tok\_eat:
            PTD\_CK(msv\_src == \textcolor{keyword}{this});
            PTD\_CK(left == mc\_null);
            PTD\_CK(right == mc\_null);
            PTD\_CK(num\_bites < MAX\_BITES);
            send(lft\_stick, tok\_take);
        \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} tok\_taken:
            PTD\_CK((msv\_src == lft\_stick) || (msv\_src == rgt\_stick));
...
\textcolor{preprocessor}{                #endif}
            ...
            \textcolor{keywordflow}{if}(msv\_src == rgt\_stick)\{
                ...
                PTD\_LOG(\textcolor{stringliteral}{"#BITES %d \(\backslash\)n"}, num\_bites);
        ...
        \textcolor{keywordflow}{case} tok\_droped:
            ...
            \textcolor{keywordflow}{if}((left == mc\_null) && (right == mc\_null))\{
                \textcolor{keywordflow}{if}(num\_bites == MAX\_BITES)\{
                    ...
                    PTD\_LOG(\textcolor{stringliteral}{"I AM FULL \(\backslash\)n"});
                    \hyperlink{log_8h_addbe1979a58d9f84d5a009c5543818c2}{mck\_sprt2}(\textcolor{stringliteral}{"I AM FULL\_\_\_\_"});
                    \hyperlink{log_8h_a2d38dfdcdb36720d61e2ce089b3a1524}{mck\_iprt}(\hyperlink{cell_8hh_af1eb47800585646e0caf6cb269111731}{mck\_get\_kernel}()->get\_workeru\_nn());
                    \hyperlink{log_8h_addbe1979a58d9f84d5a009c5543818c2}{mck\_sprt2}(\textcolor{stringliteral}{"\_\_\_\(\backslash\)n"});

                    PH\_DBG\_COD(\hyperlink{shared_8h_aa53b0f7f84415e6ca7bbea9dee5d7e57}{mc\_loop\_set\_var}(dbg\_all\_full[nn], \textcolor{keyword}{true});)
...
philosopher::call\_exit()\{
    ...
    PTD\_LOG(\textcolor{stringliteral}{"FINISHING \(\backslash\)n"});

    \textcolor{comment}{//mck\_sprt2("CALLING\_EXIT\_\_\_\_");}
    \textcolor{comment}{//mck\_iprt(mck\_get\_kernel()->get\_workeru\_nn());}
...
\textcolor{preprocessor}{#ifdef PHILO\_WITH\_DBG}
    ...
    \textcolor{keywordtype}{void} prt\_ph(\textcolor{keywordtype}{int} aa, \hyperlink{classphilosopher}{philosopher}* ph)\{
        \textcolor{keywordtype}{char} full\_str[500];
        \textcolor{keywordtype}{char}* pt = full\_str;
    ...
    \textcolor{keywordtype}{void} prt\_pc(\textcolor{keywordtype}{int} aa, philo\_workeru* pc)\{
        \textcolor{keywordtype}{char} full\_str[500];
        \textcolor{keywordtype}{char}* pt = full\_str;
        pt += sprintf(pt, \textcolor{stringliteral}{"WORKERU %d=["}, aa);
        PTD\_64\_CODE(
    ...
    \textcolor{keywordtype}{void} prt\_all\_philo()\{
        \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} aa = 0; aa < 16; aa++)\{
            philo\_workeru* phl = dbg\_all\_philo[aa];
    ...
    \textcolor{keywordtype}{void} ker\_func()\{
        ...
        \hyperlink{shared__eph3_8h_a804158edcb9b5bc2c1b2fb19d14e80d5}{mc\_workeru\_nn\_t} nn = ker->\hyperlink{classkernel_ac72d71034d07b7679c54fef29701c531}{get\_workeru\_nn}();
        \textcolor{keywordflow}{if}(! ker->did\_work && ! dbg\_all\_idle\_prt[nn])\{
            \hyperlink{shared_8h_aa53b0f7f84415e6ca7bbea9dee5d7e57}{mc\_loop\_set\_var}(dbg\_all\_idle\_prt[nn], \textcolor{keyword}{true});
        \}
        \textcolor{keywordflow}{if}(ker->did\_work && dbg\_all\_idle\_prt[nn])\{
            \hyperlink{shared_8h_aa53b0f7f84415e6ca7bbea9dee5d7e57}{mc\_loop\_set\_var}(dbg\_all\_idle\_prt[nn], \textcolor{keyword}{false});
        \}
        philo\_workeru* phl = dbg\_all\_philo[nn];

        phl->to\_manageru\_work\_sz = ker->to\_manageru\_work.calc\_size();
...
\textcolor{keywordtype}{void} mc\_workerus\_main() \{
    ...
    PH\_DBG\_COD(
        \hyperlink{shared_8h_aa53b0f7f84415e6ca7bbea9dee5d7e57}{mc\_loop\_set\_var}(dbg\_all\_idle\_prt[nn], \textcolor{keyword}{false});
        \hyperlink{shared_8h_aa53b0f7f84415e6ca7bbea9dee5d7e57}{mc\_loop\_set\_var}(dbg\_all\_full[nn], \textcolor{keyword}{false});
    )

    philo\_workeru* workeru\_dat = philo\_workeru::acquire\_alloc();
    \textcolor{keywordflow}{if}(workeru\_dat == mc\_null)\{
        \hyperlink{global_8h_a6a6d1065bccc17077e1a6a0aeaa5f6dd}{mck\_abort}(1, mc\_cstr(\textcolor{stringliteral}{"CAN NOT INIT GLB WORKERU DATA"}));
    \}

    ker->user\_data = workeru\_dat;

    PH\_DBG\_COD(
        ker->user\_func = ker\_func;
        dbg\_all\_philo[nn] = workeru\_dat;
    );
    ...
    PTD\_PRT(\textcolor{stringliteral}{"the\_handlers[0] = %p \(\backslash\)n"}, (\textcolor{keywordtype}{void}*)(the\_handlers[0]));
    ...
    PTD\_LOG(\textcolor{stringliteral}{"PHILOSOPHER %d FINISHED !!\(\backslash\)n"}, nn);
